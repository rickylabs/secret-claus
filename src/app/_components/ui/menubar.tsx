...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Root
    ref={ref}
    className={cn(
      "dark:bg-grey-700/10 flex h-9 items-center space-x-1 rounded-md bg-white/10 p-1 shadow-sm backdrop-blur-sm backdrop-blur-sm",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex cursor-default select-none items-center rounded-sm px-3 py-1 text-sm font-medium outline-none hover:bg-white/20",
      className,
    )}
    {...props}
  />
